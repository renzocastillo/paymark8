...
class AdminCmsUsersController extends \crocodicstudio\crudbooster\controllers\CBController {
	...
	public function cbInit() {
		...
		if(CRUDBooster::myPrivilegeId()==3){
			...
			$this->index_statistic[] = ['label'=>'N° Vistas Totales','count'=>DB::table('reproducciones')->where('cms_users_id',$id)->count(),'icon'=>'fa fa-video-camera','color'=>'aqua','width'=>'col-sm-2'];
			$this->index_statistic[] = ['label'=>'N° Actual de Vistas','count'=>$vistas_actuales,'icon'=>'fa fa-bars','color'=>'blue','width'=>'col-sm-2'];
			...
			$this->index_statistic[] = ['label'=>'Vistas por Efectuar','count'=>$vistas_por_efectuar,'icon'=>'fa fa-users','color'=>'yellow','width'=>'col-sm-2'];					
		}
	}
