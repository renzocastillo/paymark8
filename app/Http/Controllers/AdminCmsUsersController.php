...
class AdminCmsUsersController extends \crocodicstudio\crudbooster\controllers\CBController
{
    ...
    public function registerUser()
    {
        ...
        DB::table('cms_users')
            ->insert(['name' => $name, 'email' => $email, 'password' => $password, 'id_cms_privileges' => 3, 'created_at' => now(), 'slug' => $slug, 'whatsapp' => $whatsapp, 'cms_users_id' => $patrocinador, 'country_id' => $country_id]);
