	...
	class AdminOficinaController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			*/
			...
			$total_historico_ganancias=DB::table('solicitudes_de_pago')->where('cms_users_id',$id)->sum('monto');
			
	        $this->index_statistic[] = ['label'=>'Total Histórico de Ganancias: Dólares ganados en vistas y linkers afiliados hasta la fecha.','count'=>' $'.($total_historico_ganancias+$capacidad_de_retiro),'icon'=>'fa fa-line-chart','color'=>'blue','width'=>'col-sm-3 col-lg-6'];
