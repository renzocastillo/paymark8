<?php namespace App\Http\Controllers;
	...
	class AdminParametrosController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    */
		...
		public function getIndex(){
			...
			$data['page_title'] = "Configuración Predeterminada";
	
			$this->cbView('modules.parametros', $data);
		}
