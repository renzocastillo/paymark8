...
class AdminModuleVideosController extends \crocodicstudio\crudbooster\controllers\CBController
{
    ...
    public function cbInit()
    {
        ...
        $this->form[] = ['label' => 'Módulo', 'name' => 'modules_id', 'type' => 'select2', 'validation' => 'required|integer|min:0', 'width' => 'col-sm-10', 'datatable' => 'modules,title'];
        ...
        //$this->form[] = ["label"=>"Modules Id","name"=>"modules_id","type"=>"select2","required"=>TRUE,"validation"=>"required|integer|min:0","datatable"=>"modules,title"];
        # OLD END FORM
        ...
        */
        $this->script_js = '
	            ...
	            url: "' . url('/api/multi-upload?moduleId=' . $request['parent_id']) . '",
	            paramName: "file",
                maxFilesize: 8000,
                timeout: 3600000
	            });
        ...
        */
        ...
        |
        */
        $this->post_index_html = '<div  class="dropzone" id="my-awesome-dropzone"></div>';
