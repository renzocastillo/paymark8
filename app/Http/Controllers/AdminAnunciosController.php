...
class AdminAnunciosController extends \crocodicstudio\crudbooster\controllers\CBController
{
    ...
    public function cbInit()
    {
        ...
        $html = view('components.toggle', $params)->render();
        $this->form[] = [
            'label' => 'Público',
            'name' => 'publico',
            'type' => 'custom',
    ...
    */
    ...
    {
        $postdata['publico'] = $postdata['publico'] ?: 0;
