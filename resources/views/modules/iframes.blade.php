                ...
                <div class="box-body table-responsive no-padding">
                    ...
                    @else
                        <ul class="iframes list-unstyled row">
                            @foreach($iframes as $iframe)
                                @if($iframe->tipos_de_iframe_id == 2)
                                        ...
                                        <div class="panel panel-default">
                                            ...
                                            <div class="panel-body">
                                                <div class="attachment-block clearfix">
                                                    <img class="attachment-img" src="{{$iframe->ogp['image']}}"
                                                         alt="Attachment Image">

                                                    <div class="attachment-pushed">
                                                        <h4 class="attachment-heading"><a
                                                                    href="http://www.lipsum.com/">{{$iframe->title}}</a>
                                                        </h4>
                ...
                <div class="box-footer">
                    <ul class="pagination pagination-sm no-margin pull-right">
                        ...
                        @for($i=1; $i<=$iframes->lastPage(); $i++)
                            <li class="{{ $iframes->currentPage()==$i?'active':''}}"><a
                                        href="{{$iframes->url($i)}}">{{$i}}</a></li>
                        @endfor
