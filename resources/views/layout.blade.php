        ...
        <div class="footer-right">
            <div class="footer-icons">
                @if(!empty(CRUDBooster::getSetting('facebook')))
                    <a href="{{CRUDBooster::getSetting('facebook') }}" target="_blank"><i
            ...
            <h5 class="text-justify">Cada compra realizada a través de esta plataforma digital, a cualquiera de nuestros
                proveedores, será en beneficio de PayMark8.com que recibirá una comisión a través del programa de
                afiliados y los enlaces con los que contamos, esta plataforma tiene como finalidad aportar valor a la
                comunidad y sobre todo ayudarte en el proceso de creación del proyecto de mayor alcance de tu audiencia
                en Línea.</h5>
            <br>
            <br>
