...
<div class="container-fluid">
    <div class="row secvideo">
        ...
        <div class="col-sm-12 col-lg-3 sectexto ">
            <button data-target="#modalRegistro" data-toggle="modal" type="button" class="button1">REGISTRARME GRATIS
            </button>
...
<footer class="footer-distributed">
    ...
    <div class="footer-right">
        ...
        <p class="footer-company-about">
            ...
            <br>
        <h5 class="text-justify">Cada compra realizada a través de esta plataforma digital, a cualquiera de nuestros
            proveedores, será en beneficio de PayMark8.com que recibirá una comisión a través del programa de afiliados
            y los enlaces con los que contamos, esta plataforma tiene como finalidad aportar valor a la comunidad y
            sobre todo ayudarte en el proceso de creación del proyecto de mayor alcance de tu audiencia en Línea.</h5>
        <br>
        <br>
